...
image_dir = r'cropped'
image_messi = os.listdir(r'cropped\lionel_messi')
image_maria = os.listdir(r'cropped\maria_sharapova')
image_roger = os.listdir(r'cropped\roger_federer')
image_serena = os.listdir(r'cropped\serena_williams')
image_virat = os.listdir(r'cropped\virat_kohli')
...
image_paths = [
    r'cropped\lionel_messi\lionel_messi10.png',
    r'cropped\maria_sharapova\maria_sharapova14.png',
    r'cropped\roger_federer\roger_federer11.png',
    r'cropped\serena_williams\serena_williams6.png',
    r'cropped\virat_kohli\virat_kohli10.png'
]
